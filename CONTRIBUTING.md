# Contributing to django-sage-session

Thank you for considering contributing to `django-sage-session`! We welcome contributions from the community to help make this project better.

## Table of Contents

- [Contributing to django-sage-session](#contributing-to-django-sage-session)
...
1. **Fork the repository on GitHub**:
   ...
   Go to the [django-sage-session](https://github.com/your-username/django-sage-session) repository and click on the "Fork" button in the top-right corner.

2. **Clone your fork locally**:

   ```bash
   git clone https://github.com/your-username/django-sage-session.git
   cd django-sage-session
   ```
...
```bash
poetry run flake8
poetry run pylint sage_session
```
...
1. **Go to the [Issues](https://github.com/your-username/django-sage-session/issues) section of the repository.**
